...
def seed_database():
    ...
    if not user:
        ...
        gold_account_type.description = (
            f"Contas GOLD possuem limite diário de R${gold_limit}"
        )
        ...
        diamond_account_type.description = (
            f"Contas Diamond possuem limite diário de R${diamond_limit}"
        )
